...
namespace {
  ...
  const profileDefaults_t defaultsProfile[MAX_PROFILES] = {
    {"IUIUIU Classic",
      ...
      /*other*/ 93, true, 18.f, 0.f, 2
    },  // profile 0
    {"Londinium",
      /*pi*/true, true, 0, 0.f, 9.f, 10, 4.f, 0.f, 650, true, 0.f,
      /*sk*/true, 15, 10, 0.f, 0.f, 0.7f, 0.f, 0.f, 1, 2,
      /*tp*/true, false, 9.f, 9.f, 4, 3.f, 0, 0, 3.f, 0.f, 0.f, 0, 0.f, 0, 0, 0.f,
      /*pf*/true, false, 9.f, 3.f, 20, 0, 3.f, 0.f, 0.f, 0, 0, 0.f,
      /*other*/ 92, true, 20.f, 0.f, 2
    },  // profile 1
    {"Adaptive",
      /*pi*/true, true, 0, 0.f, 7.f, 20, 3.f, 0.f, 600, true, 0.f,
      /*sk*/true, 0, 6, 3.f, 0.f, 0.f, 0.f, 0.f, 0, 3,
      /*tp*/true, false, 0.f, 9.f, 0, 0.f, 6, 0, 0.f, 0.f, 2.f, 0, 9.f, 6, 0, 9.f,
      /*pf*/true, true, 0.f, 0.f, 30, 0, 3.f, 0.f, 2.5f, 30, 0, 9.f,
    ...
    {"Filter 2.1",
      ...
      /*other*/ 89, true, 18.f, 0.f, 
    },  // profile 3
    {"Blooming espresso",
      /*pi*/true, true, 0, 0.f, 4.f, 20, 7.f, 0.f, 650, true, 0.f,
      /*sk*/true, 0, 30, 0.f, 0.f, 0.6f, 0.f, 5.f, 5, 2,
      /*tp*/true, true, 0.f, 0.f, 0, 0.f, 0, 0, 0.f, 2.f, 2.f, 1, 9.f, 0, 4, 9.f,
      /*pf*/true, true, 0.f, 0.f, 0, 0, 0.f, 2.f, 2.f, 15, 0, 6.f,
      /*other*/ 93, true, 18.f, 0.f, 2
    }  // profile 4
  };
}
